...
class Image implements ResponsiveImageable
{
    ...
    /**
     * @var Map<string, ResponsibleImagesOptionType> options to pass to the URL maker
     */
     ...
     * Constructor.
     *
     * @param  array<string, ResponsibleImagesOptionType>  $options  options to pass to the URL maker class
     */
